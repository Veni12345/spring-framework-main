...
integrate such parsers into the Spring IoC_BeanFactory container.
...
Creating an XML configuration extension for use with Spring's IoC_BeanFactory container starts with
