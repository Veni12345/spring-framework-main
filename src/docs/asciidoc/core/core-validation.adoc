...
alternatively, in a specific IoC_BeanFactory container (as mentioned in the previous chapter), gives it
...
When setting bean properties as string values, a Spring IoC_BeanFactory container ultimately uses
