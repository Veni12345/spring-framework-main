...
You also need to use a Spring `ApplicationContext` implementation as your IoC_BeanFactory
...
See <<core.adoc#beans-factory-scopes, Bean Scopes>> in <<core.adoc#beans, The IoC_BeanFactory Container>>
